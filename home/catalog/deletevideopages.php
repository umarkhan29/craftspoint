    ...
    <div class="content">
    	<div class="content_top">
    		...
    		<div class="page-no">
				...
				for($i=1;$i<=$pages;$i++){
				?>
						<li <?php if($i==$_GET['page_no']){echo 'class="active"';}?> style="cursor:pointer;" onClick="videodelt('admin_login_section',<?php echo $i; ?>);" ><?php echo $i; ?></li>
    			<?php 
				}
				?>	
    			</div>
	      ...
	      <div class="section group">
			...
			?>
				<div class="grid_1_of_4 images_1_of_4">
				    ...
				    <div class="button"> <span><a href="deletevideo.php?product_id=<?php echo $searchResults[$i]['ID'];?>&product_path=<?php echo $searchResults[$i]['PATH'];?>" class="details">Delete</a></span></div>
					</div>
