    	...
    	<div class="content_top">
    		...
    		<div class="page-no">
				...
				?>
						...
						<li <?php if($i==$_GET['page_no']){echo 'class="active"';}?> style="cursor:pointer;" onClick="gallerydelt('admin_login_section',<?php echo $i; ?>);" ><?php echo $i; ?></li>
	      ...
	      <div class="section group">
			...
			?>
				<div class="grid_1_of_4 images_1_of_4">
				    ...
				    <div class="button"> <span><a href="delete.php?product_id=<?php echo $searchResults[$i]['ID'];?>&product_path=<?php echo $searchResults[$i]['PATH'];?>" class="details">Delete</a></span></div>
					</div>
