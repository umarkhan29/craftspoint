...
<div id="admin_login_section">
			<?php
			$products=mysql_query("SELECT * FROM `products`") or die("Db error");
		...
		?>
			...
			<div class="main">
				<div class="content">
					...
					<li  <?php if($i==1){echo 'class="active"';}?> style="cursor:pointer;" onClick="productdelt('admin_login_section',<?php echo $i; ?>);" ><?php echo $i; ?></li>
						...
						?>
							<div class="grid_1_of_4 images_1_of_4">
								<img src="<?php echo $items[$i]['PATH'];?>" height="180" alt="" />
								 ...
								 <div class="button"> <span><a href="deltproduct.php?product_id=<?php echo $items[$i]['ID'];?>&product_path=<?php echo $items[$i]['PATH'];?>" class="details">Delete</a></span></div>
...
function productdelt(thediv,number){
	...
	xmlhttp.open('GET','home/catalog/deleteproductspage.php?page_no='+number,true);
